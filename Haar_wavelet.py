...
def generate_level_avg_signals(trend_data, fluctuation_data, level):
    """Generates the detail and averaged signals for each level of analysis 
    specified. Takes as input the trend and fluctuation data generated by the
    generate_fluctuation_trend_subsignals() function. Depends on the function
    generate_mlevel_vectors()"""
